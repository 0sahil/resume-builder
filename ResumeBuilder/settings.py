...
SECRET_KEY = 'django-insecure-g7#6++$hvth91#)&-m)u=1rbm7n_!bfmo%5lofh2wpfn3ylb)c'
...
STATICFILES_DIRS = (
    ...
    os.path.join(BASE_DIR, "media/resume_templates"),
    os.path.join(BASE_DIR, "media/all_resumes"),
)
